                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                res.onerror = function (er) {
                                    _this.log(LogType.Warn, ['indexDB 初始化失败', er]);
                                    resolve(undefined);
                                };
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                res.onsuccess = function () {
                                    ...
                                    storeRes.onsuccess = function () {
                                        _this.log(LogType.Success, ["\u5B58\u5165\u6210\u529F name: " + name + " value: ", value]);
                                        resolve(undefined);
                                    };
                                    storeRes.onerror = function (er) {
                                        _this.log(LogType.Warn, ["\u5B58\u5165\u5931\u8D25 name: " + name + " value: ", value, 'error:', er]);
                                        resolve('存入失败');
                                    };
                                };
                                res.onerror = function (er) {
